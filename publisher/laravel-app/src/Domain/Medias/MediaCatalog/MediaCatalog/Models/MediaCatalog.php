...
namespace Domain\Medias\MediaCatalog\MediaCatalog\Models;
...
final class MediaCatalog extends Model
{
    protected $table = MediaCatalogEnum::TABLE_NAME->value;

    protected $fillable = ['jewellery_id','media_type_id','name','slug','is_active'];

    public const string TYPE_RESOURCE = MediaCatalogEnum::TYPE_RESOURCE->value;
