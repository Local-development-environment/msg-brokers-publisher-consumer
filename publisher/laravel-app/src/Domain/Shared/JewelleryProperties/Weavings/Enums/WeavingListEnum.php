...
enum WeavingListEnum: string
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::GARIBALDI => 'плоское плетение, где два звена соединены друг с другом под углом',
    ...
    public function baseWeaving(): string
    {
        return match ($this) {
            ...
            self::GARIBALDI => BaseWeavingListEnum::BISMARCK->value,
            ...
            self::ROMBO, self::ANCHOR, self::ROLLO, self::CHOPARD, self::CORDA => BaseWeavingListEnum::ANCHOR->value,

        };
    }

//    public function altNames(): string
//    {
//        return match ($this) {
//            self::BYZANTINE => '',
