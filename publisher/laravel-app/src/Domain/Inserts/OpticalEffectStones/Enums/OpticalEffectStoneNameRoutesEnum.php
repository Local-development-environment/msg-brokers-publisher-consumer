...
enum OpticalEffectStoneNameRoutesEnum: string
{
    ...
    case RELATED_TO_OPTICAL_EFFECT_STONES    = 'optical-effect-stones.optical-effect';
    case RELATIONSHIP_TO_OPTICAL_EFFECT_STONES = 'optical-effect-stones.relationships.optical-effect';
}
