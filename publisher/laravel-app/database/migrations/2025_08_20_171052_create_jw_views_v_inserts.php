            ...
            with
                cte_inserts as (
                    select
                        ...
                        i.stone_exterior_id as stone_exterior_id,
                        ioi.id as insert_optional_info_id,
                        ioi.info as insert_optional_info,
                        i.quantity as quantity_stones,
                        i.dimensions as stone_dimension,
                        i.weight as insert_total_stone_weight,
                        i.unit as unit_stone_weight,
                        c.id as colour_id,
                    ...
                    join jw_inserts.stone_exteriors as sex on s.id = sex.stone_id
                    join jw_inserts.colours as c on sex.colour_id = c.id
                    join jw_inserts.facets as f on sex.facet_id = f.id
                    join jw_inserts.inserts as i on sex.id = i.stone_exterior_id
