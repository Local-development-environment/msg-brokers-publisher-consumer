...
use App\Http\JsonApiSpecification\Exceptions\UnknownRelationshipException;
...
use App\Http\JsonApiSpecification\Supports\Includes;
use Closure;
...
trait Relationships
{
     ...
     *
     */
    private function resolveInclude(mixed $resource, string $prefix): JsonApiResourceCollection|JsonApiResource|null
    {
        return match (true) {
     ...
     */
    private function resolveRelationships(Request $request): Collection
    {
     ...
     * @return class-string
     */
    private static function guessRelationshipResource(string $relationship, JsonApiResource $resource): string
    {
