...
final class NeckSizeUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'data.type'             => ['required','string','in:' . NeckSize::TYPE_RESOURCE],
            'data.attributes'       => ['required','array:value,length_name_id,unit','min:1'],
            'data.attributes.value' => [
                'sometimes','required','numeric','unique:pgsql_pub.jw_properties.neck_sizes,value'
            ],
