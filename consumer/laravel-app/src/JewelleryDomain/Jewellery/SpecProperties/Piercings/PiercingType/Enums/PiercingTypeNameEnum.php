...
use JewelleryDomain\Jewellery\SpecProperties\Piercings\PiercingSite\Enums\PiercingSiteNameEnum;

enum PiercingTypeNameEnum: string
{
    case BARBELL  = 'штанга';
    case LABRET   = 'лабрет';
    case CLICKER  = 'кликер';
    ...
    public function suitable(): array
    {
        return match ($this) {
            ...
            self::RINGS,
            self::CIRCULAR => [
                PiercingSiteNameEnum::NOSE->value,
                PiercingSiteNameEnum::NAVEL->value,
                PiercingSiteNameEnum::LIPS->value,
                PiercingSiteNameEnum::EARS->value,
                PiercingSiteNameEnum::BROWS->value,
            ],
            self::LABRET   => [
                PiercingSiteNameEnum::EARS->value,
                PiercingSiteNameEnum::NOSE->value,
