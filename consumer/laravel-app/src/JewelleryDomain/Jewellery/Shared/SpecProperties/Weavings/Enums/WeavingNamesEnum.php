...
namespace JewelleryDomain\Jewellery\Shared\SpecProperties\Weavings\Enums;

use JewelleryDomain\Jewellery\Shared\SpecProperties\BaseWeavings\Enums\BaseWeavingNamesEnum;

enum WeavingNamesEnum: string
{
    ...
    public function baseWeaving(): string
    {
        return match ($this) {
            ...
            self::PYTHON        => BaseWeavingNamesEnum::BISMARCK->value,
            self::PANTHER_DOUBLE,
            ...
            self::ROMBO,
            self::TRIPLE_ROMBO,
            self::DOUBLE_ROMBO  => BaseWeavingNamesEnum::PANTHER->value,
            self::ANCHOR,
            self::ROLLO,
            self::CHOPARD,
            self::CORDA,
            self::DOUBLE_ANCHOR => BaseWeavingNamesEnum::ANCHOR->value,
        };
    }
    ...
    public function jwProbability(): int
    {
        return match ($this) {
            self::BYZANTINE        => 10,
            self::CLASSIC_BISMARCK => 10,
            self::BISMARCK_DOUBLE  => 0,
            self::BISMARCK_TRIPLE  => 0,
            self::PYTHON           => 10,
            self::PANTHER_DOUBLE   => 0,
            self::PANTHER_CLASSIC  => 10,
            self::NONNA            => 10,
            self::GOURMETTE        => 0,
            self::LOVE             => 0,
            self::SINGAPORE        => 10,
